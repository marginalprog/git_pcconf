...
"border-top: 1px solid rgb(220, 0, 0);")
        ...
        self.lbPrice.setGeometry(QtCore.QRect(160, 440, 111, 21))
        font = QtGui.QFont()
        font.setFamily("Montserrat SemiBold")
        font.setPointSize(10)
...
"}")
        ...
        self.lbNcores.setGeometry(QtCore.QRect(160, 250, 131, 21))
        font = QtGui.QFont()
        font.setFamily("Montserrat SemiBold")
        font.setPointSize(10)
        ...
        self.lePrice.setGeometry(QtCore.QRect(160, 470, 111, 31))
        font = QtGui.QFont()
        font.setFamily("Montserrat Medium")
        font.setPointSize(10)
...
"}")
        ...
        self.leRamFreq.setGeometry(QtCore.QRect(310, 280, 111, 31))
        font = QtGui.QFont()
        font.setFamily("Montserrat Medium")
        font.setPointSize(10)
...
"}")
        ...
        self.lbRamFreq.setGeometry(QtCore.QRect(310, 250, 181, 21))
        font = QtGui.QFont()
        font.setFamily("Montserrat SemiBold")
        font.setPointSize(10)
...
"}")
        ...
        self.leNcores.setGeometry(QtCore.QRect(160, 280, 111, 31))
        font = QtGui.QFont()
        font.setFamily("Montserrat Medium")
        font.setPointSize(10)
...
"}")
        ...
        self.lbSeries.setGeometry(QtCore.QRect(310, 170, 101, 21))
        font = QtGui.QFont()
        font.setFamily("Montserrat SemiBold")
        font.setPointSize(10)
...
"}")
        ...
        self.lbTechproc.setGeometry(QtCore.QRect(20, 350, 131, 21))
        font = QtGui.QFont()
        font.setFamily("Montserrat SemiBold")
        font.setPointSize(10)
...
"QCalendarWidget QAbstractItemView:disabled { color: rgb(80, 80, 80); }")
        ...
        self.leSeries.setGeometry(QtCore.QRect(310, 200, 111, 31))
        font = QtGui.QFont()
        font.setFamily("Montserrat Medium")
        font.setPointSize(10)
...
"}")
        ...
        self.lbCache.setGeometry(QtCore.QRect(160, 350, 111, 21))
        font = QtGui.QFont()
        font.setFamily("Montserrat SemiBold")
        font.setPointSize(10)
        ...
        self.leCache.setGeometry(QtCore.QRect(160, 380, 111, 31))
        font = QtGui.QFont()
        font.setFamily("Montserrat Medium")
        font.setPointSize(10)
...
"")
    ...
    def retranslateUi(self, addChProcWidg):
        ...
        self.lbRamFreq.setText(_translate("addChProcWidg", "Макс. частота ОЗУ [МГц]"))
        ...
        self.lbTechproc.setText(_translate("addChProcWidg", "Техпроцесс [нм]"))
