...
"")
        ...
        self.lbInterface.setGeometry(QtCore.QRect(20, 350, 141, 21))
        font = QtGui.QFont()
        font.setFamily("Montserrat SemiBold")
        font.setPointSize(10)
...
"")
    ...
    def retranslateUi(self, addChVidWidg):
        ...
        self.lbInterface.setText(_translate("addChVidWidg", "Тип интерфейса"))
        self.lbMonitor.setText(_translate("addChVidWidg", "Мониторы"))
        self.lbResolution.setText(_translate("addChVidWidg", "Разрешение"))
        self.lbLength.setText(_translate("addChVidWidg", "Длина [см]"))
