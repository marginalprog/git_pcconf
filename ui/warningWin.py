...
"")
        ...
        self.line.setGeometry(QtCore.QRect(10, 70, 351, 20))
...
"border-top: 1px solid rgb(220, 0, 0);")
        ...
        self.lbErr.setGeometry(QtCore.QRect(250, 40, 101, 21))
        font = QtGui.QFont()
        font.setFamily("Montserrat SemiBold")
        font.setPointSize(11)
        self.lbErr.setFont(font)
        self.lbErr.setStyleSheet("border:0px;")
        self.lbErr.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lbErr.setObjectName("lbErr")
        self.lbErrDescription = QtWidgets.QLabel(warningDialog)
        self.lbErrDescription.setGeometry(QtCore.QRect(10, 70, 351, 71))
        font = QtGui.QFont()
...
"border: 1px solid rgb(210, 0, 0);")
        ...
        self.btnCancel.setGeometry(QtCore.QRect(130, 170, 111, 31))
        font = QtGui.QFont()
        font.setFamily("Montserrat SemiBold")
        font.setPointSize(10)
...
"")
        ...
        self.line_2.setGeometry(QtCore.QRect(10, 140, 351, 21))
